...
const REVIEWS = [
  {
    id: 1,
    product: '닥터지 선케어 1호 세트 선물포장 단체선물 답례품 기념품 판촉물',
    type: '한달사용',
    rating: 5,
    user: 'wi****',
    date: '2026.05.21',
    text: '운동할때 잘쓰고있어요',
    related: '현장나갈때 잘 바르고다녀요',
    help: 0,
    img: null,
  },
  {
    id: 2,
    product: '락앤락 DTF,레이저 각인 커스텀 텀블러 11종',
    type: '한달사용',
    rating: 5,
    user: 'vulp*****',
    date: '2026.05.18',
    text: '색상도 예쁘고 가벼워요~\n손잡이가 신의 한수에요!!!\n손잡이 덕에 편히 들고 다닐 수 있어요👍\n맘에 쏙 듭니당🥰',
    related: '',
    help: 0,
    img: 'review_01.jpg',
  },
  {
    id: 3,
    product: '[레이저각인] 락앤락 스쿨핏 스위치캡 텀블러 380ml 보온보냉병 선물포장',
    type: '일반',
    rating: 4,
    user: 'ulcu***',
    date: '2026.05.16',
  ...
  {
    id: 4,
    product: '[락앤락] 마일드 원터치텀블러 가벼운중량 보온보냉병 초경량 500ml, 스카이블루',
    type: '일반',
    rating: 4,
    user: 'logo*****',
    date: '2026.04.29',
    text: '가격대비 만족합니다. 가성비로...',
    related: '',
    help: 0,
    img: null,
  },
  ...
  },
  {
    ...
    user: 'nam2***',
    date: '2026.04.04',
    text: '저번에 주문하고 넘 맘에들어서 선물용으로 축구팀원한테 선물주려고 한개 더 주문 ㅋㅋㅋ\n\n디테일 역시 끝내줍니다 더 주문할듯!!',
    related: '',
    help: 1,
    img: 'review_04.jpg',
  },
  {
    ...
    user: 'nam2***',
    date: '2026.04.04',
    text: '머그컵이랑 텀블러 주문했는데 진짜 퀄리티가 너무 완벽합니다👏 \n하나는 축구팀 로고로, 하나는 귀여운 이미지로 제작했는데 디테일이 진짜 끝판왕이에요.  \n색감도 선명하고 마감도 깔끔해서 받자마자 감탄했습니다.\n선물용으로도 너무 좋아서 몇 개 더 주문할겁니다\n디자인 고민 중이신 분들 강력 추천드립니다👍',
    related: '',
    help: 1,
    img: 'review_05.jpg',
  },
  {
    ...
    user: 'gkdl****',
    date: '2026.03.30',
    text: '운동갈때 들고가려고 주문했는데 튼튼한 락앤락이라 오래사용할수 있을것 같아요!\n그리고 우리강아지들 운동할때도 볼수있어서 기분이 참 좋습니다 :)🧡\n같이보내준 볼펜과 사진들은 아까워서 사용못하겠어요ㅠㅠㅠ그래서 계속 간직하려고용🥹🥹\n\n진짜 찐만족!!!\n고민말고 꼭 구매하시길🧡🧡',
    related: '',
    help: 1,
    img: 'review_06.jpg',
  },
  {
    ...
    user: 'ykok***',
    date: '2026.03.25',
    text: '너무 너무 너무 대만족입니당 회사에서 쓰려고 샀는데 볼때마다 힐링될거같아요 ㅠㅠ 반려동물 키우는 사람이면 무조건 대만족할거같네요😍 서비스로 주신 볼펜은 아마 아까워서 소장할거같구요... 스티커도 어디다 붙일지 신중하게 고민해서 사용할게요 감사합니다 😍😍',
    related: '',
    help: 1,
    img: 'review_07.jpg',
  },
  {
    ...
    user: 'te****',
    date: '2026.03.23',
    text: '우선 락앤락 텀블러 자체가 너무 깔끔해서 좋구요\n실리콘 손잡이도 들고 다닐 때 손에 착 감겨서 편안함!\n\n그리고 이 깔끔한 텀블러에 들어간 내새끼!!\n아 진짜 미친 귀여움입니다 ㅠㅠ\n보낸 사진 그대로 털무늬에 표정까지 섬세하게 표현된 거 보고 감탄했어요\n\n제작 상품이라 오래 걸릴 줄 알았는데\n주문하고 딱 3일 만에 도착! 로켓배송인줄\n\n이거 들고 출근하니 내새끼랑 같이 온거 같아 기분이 너무 좋아요',
    related: '',
    help: 1,
    img: 'review_08.jpg',
  },
